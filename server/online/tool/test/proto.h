...
enum {
	cli_proto_max_len = 10 * 1024, 		// client 发送给 online 协议包的最大长度
	srv_proto_max_len = 1024 * 1024, 	// 其他 server 发送给 online 协议包的最大长度
	home_proto_max_len = 1024 * 1024,          // online 发送给 home 协议包的最大长度
};
...
enum {
    ...
    db_cmd_get_boss_info = 0x1A01,
    db_cmd_get_gameflag = 0x0007,

    seer2_cmd_get_simple_info = 0x2A40,

    seer_cmd_check_user_exist = 0x180E,

    flower_cmd_is_flower = 62034,
    kongfu_cmd_is_kongfu = 0x2E04,
};
