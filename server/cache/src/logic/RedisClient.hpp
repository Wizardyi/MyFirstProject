...
public:
    ...
    int Setbit(const std::string &strKey, const std::string& strOffset, bool bVal, Pipeline ppLine = nullptr);
	...
	int Zadd(const std::string &strKey, const std::string& strScore, const std::string &strElem, long *pnVal = nullptr, Pipeline = nullptr);
    ...
    int Zrevrangewithscore(const std::string &strKey, long nStart, long nStop, std::vector<std::pair<std::string, std::string> > *pmapVal, Pipeline ppLine = nullptr);
    int Zrangewithscore(const std::string &strKey, long nStart, long nStop, std::vector<std::pair<std::string, std::string> > *pmapVal, Pipeline ppLine = nullptr);
    ...
    int Zrevrangebyscore(const std::string &strKey, const std::string& strMax, const std::string& strMin, std::vector<std::string> *pvecVal, Pipeline ppLine = nullptr);
